            ...
            var counterUpper = function () {
                ...
                for (var i = divisions; i >= counter.beginAt / num * divisions; i--) {
                    ...
                    for (var iter = 0; iter < lenO; iter++) {
                        ...
                        if (newNum[iter] == '0')
                            c = '০';
                        else if (newNum[iter] == '1')
                            c = '১';
                        else if (newNum[iter] == '2')
                            c = '২';
                        else if (newNum[iter] == '3')
                            c = '৩';
                        else if (newNum[iter] == '4')
                            c = '৪';
                        else if (newNum[iter] == '5')
                            c = '৫';
                        else if (newNum[iter] == '6')
                            c = '৬';
                        else if (newNum[iter] == '7')
                            c = '৭';
                        else if (newNum[iter] == '8')
                            c = '৮';
                        else if (newNum[iter] == '9')
                            c = '৯';
